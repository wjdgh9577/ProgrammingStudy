...
#        카드의 합이 21을 넘지 않는 한도 내에서, 카드의 합을 최대한 크게 만드
...
#        한다. 블랙잭 변형 게임이기 때문에, 플레이어가 고른 카드의 합은 M을
#        넘지 않으면서 M과 최대한 가깝게 만들어야 한다.
#        N장의 카드에 써져 있는 숫자가 주어졌을 때, M을 넘지 않으면서 M에
#        최대한 가까운 카드 3장의 합을 구해 출력하시오.
# 입력 : 첫째 줄에 카드의 개수 N(3 ≤ N ≤ 100)과 M(10 ≤ M ≤ 300,000)이
#        주어진다. 둘째 줄에는 카드에 쓰여 있는 수가 주어지며,
...
'''
#set 대신 MAX 변수를 사용한 코드
#부등식이 하나 더 있어서 그런지 시간이 더 오래 걸린다
